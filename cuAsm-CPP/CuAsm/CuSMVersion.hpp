...
public:
     ...
     *        bytes, mirroring CuSMVersion.mergeCtrlCodes (mergeCtrlCodes_5x_6x/mergeCtrlCodes_7x_8x),
     *        the inverse of splitCtrlCodeFromBytes.
     * @param insCodeList Instruction codes, one per instruction.
    ...
    /**
     * @brief Gets the NVInfo attribute set that can be automatically generated by the kernel
     *        assembler, mirroring CuSMVersion.getNVInfoAttrAutoGenSet.
     * @return The auto-generated attribute set for this arch.
     **/
    const std::set<std::string>& getNVInfoAttrAutoGenSet() const;

    /**
     * @brief Gets the NVInfo attribute set that should be generated manually by the kernel
     *        assembler, mirroring CuSMVersion.getNVInfoAttrManualGenSet.
     * @return The manually-generated attribute set for this arch.
     **/
    const std::set<std::string>& getNVInfoAttrManualGenSet() const;
