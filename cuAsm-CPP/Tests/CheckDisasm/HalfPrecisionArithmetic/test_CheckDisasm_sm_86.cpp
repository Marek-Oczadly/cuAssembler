...
/**
 * @brief Round-trips the HalfPrecisionArithmetic kernel through nvcc -> disassemble -> reassemble for
 ...
 **/
int main() {
    return CuAsm::Test::runCheckDisasm("HalfPrecisionArithmetic", "sm_86") ? 0 : 1;
}
