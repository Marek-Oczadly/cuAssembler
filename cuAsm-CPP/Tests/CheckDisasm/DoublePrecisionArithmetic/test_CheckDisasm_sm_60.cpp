...
/**
 * @brief Round-trips the DoublePrecisionArithmetic kernel through nvcc -> disassemble -> reassemble for
 ...
 **/
int main() {
    return CuAsm::Test::runCheckDisasm("DoublePrecisionArithmetic", "sm_60") ? 0 : 1;
}
