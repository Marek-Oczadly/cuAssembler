...
/**
 * @brief Shuffles a legal subset of the Int64Arithmetic kernel fixture's instructions (sm_75), runs
 ...
 **/
int main() {
    return CuAsm::Test::runCheckControlCodesShuffle("Int64Arithmetic", "sm_75") ? 0 : 1;
}
