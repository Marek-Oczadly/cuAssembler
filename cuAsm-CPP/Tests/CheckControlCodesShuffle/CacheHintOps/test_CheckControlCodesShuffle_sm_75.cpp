...
/**
 * @brief Shuffles a legal subset of the CacheHintOps kernel fixture's instructions (sm_75), runs
 ...
 **/
int main() {
    return CuAsm::Test::runCheckControlCodesShuffle("CacheHintOps", "sm_75") ? 0 : 1;
}
