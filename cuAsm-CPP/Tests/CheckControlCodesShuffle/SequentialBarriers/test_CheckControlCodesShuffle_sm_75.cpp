...
/**
 * @brief Shuffles a legal subset of the SequentialBarriers kernel fixture's instructions (sm_75), runs
 ...
 **/
int main() {
    return CuAsm::Test::runCheckControlCodesShuffle("SequentialBarriers", "sm_75") ? 0 : 1;
}
