...
/**
 * @brief Shuffles a legal subset of the CooperativeGroups kernel fixture's instructions (sm_75), runs
 ...
 **/
int main() {
    return CuAsm::Test::runCheckControlCodesShuffle("CooperativeGroups", "sm_75") ? 0 : 1;
}
