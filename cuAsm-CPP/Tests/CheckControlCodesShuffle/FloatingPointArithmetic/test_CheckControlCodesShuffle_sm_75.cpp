...
/**
 * @brief Shuffles a legal subset of the FloatingPointArithmetic kernel fixture's instructions (sm_75), runs
 ...
 **/
int main() {
    return CuAsm::Test::runCheckControlCodesShuffle("FloatingPointArithmetic", "sm_75") ? 0 : 1;
}
