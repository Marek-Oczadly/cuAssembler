...
/**
 * @brief Shuffles a legal subset of the TensorCoreOps kernel fixture's instructions (sm_75), runs
 ...
 **/
int main() {
    return CuAsm::Test::runCheckControlCodesShuffle("TensorCoreOps", "sm_75") ? 0 : 1;
}
