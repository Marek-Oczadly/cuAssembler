...
/**
 * @brief Shuffles a legal subset of the TextureOps kernel fixture's instructions (sm_75), runs
 ...
 **/
int main() {
    return CuAsm::Test::runCheckControlCodesShuffle("TextureOps", "sm_75") ? 0 : 1;
}
