...
/**
 * @brief Shuffles a legal subset of the DeviceFunctionCalls kernel fixture's instructions (sm_75), runs
 ...
 **/
int main() {
    return CuAsm::Test::runCheckControlCodesShuffle("DeviceFunctionCalls", "sm_75") ? 0 : 1;
}
