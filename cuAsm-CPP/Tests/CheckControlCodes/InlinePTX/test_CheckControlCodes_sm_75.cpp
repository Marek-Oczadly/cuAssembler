...
/**
 * @brief Compiles the InlinePTX kernel fixture for sm_75, decodes its real ptxas-scheduled control
 ...
 **/
int main() {
    return CuAsm::Test::runCheckControlCodes("InlinePTX", "sm_75") ? 0 : 1;
}
