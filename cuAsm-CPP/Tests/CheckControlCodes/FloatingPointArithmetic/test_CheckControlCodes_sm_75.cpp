...
/**
 * @brief Compiles the FloatingPointArithmetic kernel fixture for sm_75, decodes its real ptxas-scheduled control
 ...
 **/
int main() {
    return CuAsm::Test::runCheckControlCodes("FloatingPointArithmetic", "sm_75") ? 0 : 1;
}
