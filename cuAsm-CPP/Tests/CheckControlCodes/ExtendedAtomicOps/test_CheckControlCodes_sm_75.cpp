...
/**
 * @brief Compiles the ExtendedAtomicOps kernel fixture for sm_75, decodes its real ptxas-scheduled control
 ...
 **/
int main() {
    return CuAsm::Test::runCheckControlCodes("ExtendedAtomicOps", "sm_75") ? 0 : 1;
}
