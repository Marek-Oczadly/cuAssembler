...
/**
 * @brief Compiles the LargeKernel kernel fixture for sm_75, decodes its real ptxas-scheduled control
 ...
 **/
int main() {
    return CuAsm::Test::runCheckControlCodes("LargeKernel", "sm_75") ? 0 : 1;
}
