...
/**
 * @brief Compiles the HalfPrecisionArithmetic kernel fixture for sm_75, decodes its real ptxas-scheduled control
 ...
 **/
int main() {
    return CuAsm::Test::runCheckControlCodes("HalfPrecisionArithmetic", "sm_75") ? 0 : 1;
}
