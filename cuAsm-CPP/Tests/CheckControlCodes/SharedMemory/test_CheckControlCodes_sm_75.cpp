...
/**
 * @brief Compiles the SharedMemory kernel fixture for sm_75, decodes its real ptxas-scheduled control
 ...
 **/
int main() {
    return CuAsm::Test::runCheckControlCodes("SharedMemory", "sm_75") ? 0 : 1;
}
