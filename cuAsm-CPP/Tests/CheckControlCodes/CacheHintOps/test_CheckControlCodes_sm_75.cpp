...
/**
 * @brief Compiles the CacheHintOps kernel fixture for sm_75, decodes its real ptxas-scheduled control
 ...
 **/
int main() {
    return CuAsm::Test::runCheckControlCodes("CacheHintOps", "sm_75") ? 0 : 1;
}
