...
/**
 * @brief Compiles the MatrixMultiply kernel fixture for sm_75, decodes its real ptxas-scheduled control
 ...
 **/
int main() {
    return CuAsm::Test::runCheckControlCodes("MatrixMultiply", "sm_75") ? 0 : 1;
}
