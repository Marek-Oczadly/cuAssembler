...
/**
 * @brief Compiles the ConstantMemory kernel fixture for sm_75, decodes its real ptxas-scheduled control
 ...
 **/
int main() {
    return CuAsm::Test::runCheckControlCodes("ConstantMemory", "sm_75") ? 0 : 1;
}
