 ...
 *        re-verify round trip for the FloatingPointArithmetic kernel fixture (sm_75) -- see
 ...
 **/
int main() {
    return CuAsm::Test::runCheckControlCodesRoundtrip("FloatingPointArithmetic", "sm_75") ? 0 : 1;
}
