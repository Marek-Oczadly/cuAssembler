...
/**
 * @brief Shuffles a legal subset of the HalfPrecisionArithmetic kernel fixture's instructions (sm_75), runs
 ...
 **/
int main() {
    return CuAsm::Test::runCheckControlCodesShuffle("HalfPrecisionArithmetic", "sm_75") ? 0 : 1;
}
