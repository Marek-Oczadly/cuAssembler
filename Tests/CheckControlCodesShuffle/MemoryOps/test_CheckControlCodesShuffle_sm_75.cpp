...
/**
 * @brief Shuffles a legal subset of the MemoryOps kernel fixture's instructions (sm_75), runs
 ...
 **/
int main() {
    return CuAsm::Test::runCheckControlCodesShuffle("MemoryOps", "sm_75") ? 0 : 1;
}
