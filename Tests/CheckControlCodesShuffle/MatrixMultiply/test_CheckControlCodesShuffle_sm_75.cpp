...
/**
 * @brief Shuffles a legal subset of the MatrixMultiply kernel fixture's instructions (sm_75), runs
 ...
 **/
int main() {
    return CuAsm::Test::runCheckControlCodesShuffle("MatrixMultiply", "sm_75") ? 0 : 1;
}
