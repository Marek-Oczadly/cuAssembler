...
/**
 * @brief Shuffles a legal subset of the InlinePTX kernel fixture's instructions (sm_75), runs
 ...
 **/
int main() {
    return CuAsm::Test::runCheckControlCodesShuffle("InlinePTX", "sm_75") ? 0 : 1;
}
