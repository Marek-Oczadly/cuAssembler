...
/**
 * @brief Shuffles a legal subset of the SharedMemory kernel fixture's instructions (sm_75), runs
 ...
 **/
int main() {
    return CuAsm::Test::runCheckControlCodesShuffle("SharedMemory", "sm_75") ? 0 : 1;
}
