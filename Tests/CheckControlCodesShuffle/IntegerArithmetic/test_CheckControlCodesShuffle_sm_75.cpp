...
/**
 * @brief Shuffles a legal subset of the IntegerArithmetic kernel fixture's instructions (sm_75), runs
 ...
 **/
int main() {
    return CuAsm::Test::runCheckControlCodesShuffle("IntegerArithmetic", "sm_75") ? 0 : 1;
}
