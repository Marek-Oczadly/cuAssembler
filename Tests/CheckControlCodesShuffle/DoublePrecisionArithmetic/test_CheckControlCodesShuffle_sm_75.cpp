...
/**
 * @brief Shuffles a legal subset of the DoublePrecisionArithmetic kernel fixture's instructions (sm_75), runs
 ...
 **/
int main() {
    return CuAsm::Test::runCheckControlCodesShuffle("DoublePrecisionArithmetic", "sm_75") ? 0 : 1;
}
