...
/**
 * @brief Compiles the AtomicOps kernel fixture for sm_75, decodes its real ptxas-scheduled control
 ...
 **/
int main() {
    return CuAsm::Test::runCheckControlCodes("AtomicOps", "sm_75") ? 0 : 1;
}
