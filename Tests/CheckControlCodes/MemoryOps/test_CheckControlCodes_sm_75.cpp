...
/**
 * @brief Compiles the MemoryOps kernel fixture for sm_75, decodes its real ptxas-scheduled control
 ...
 **/
int main() {
    return CuAsm::Test::runCheckControlCodes("MemoryOps", "sm_75") ? 0 : 1;
}
