...
/**
 * @brief Compiles the DoublePrecisionArithmetic kernel fixture for sm_75, decodes its real ptxas-scheduled control
 ...
 **/
int main() {
    return CuAsm::Test::runCheckControlCodes("DoublePrecisionArithmetic", "sm_75") ? 0 : 1;
}
