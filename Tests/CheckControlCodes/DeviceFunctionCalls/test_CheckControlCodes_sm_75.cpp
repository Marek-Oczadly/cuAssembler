...
/**
 * @brief Compiles the DeviceFunctionCalls kernel fixture for sm_75, decodes its real ptxas-scheduled control
 ...
 **/
int main() {
    return CuAsm::Test::runCheckControlCodes("DeviceFunctionCalls", "sm_75") ? 0 : 1;
}
