...
/**
 * @brief Compiles the TextureOps kernel fixture for sm_75, decodes its real ptxas-scheduled control
 ...
 **/
int main() {
    return CuAsm::Test::runCheckControlCodes("TextureOps", "sm_75") ? 0 : 1;
}
