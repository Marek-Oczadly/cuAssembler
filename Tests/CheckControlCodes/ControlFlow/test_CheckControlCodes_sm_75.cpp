...
/**
 * @brief Compiles the ControlFlow kernel fixture for sm_75, decodes its real ptxas-scheduled control
 ...
 **/
int main() {
    return CuAsm::Test::runCheckControlCodes("ControlFlow", "sm_75") ? 0 : 1;
}
