...
/**
 * @brief Compiles the Intrinsics kernel fixture for sm_75, decodes its real ptxas-scheduled control
 ...
 **/
int main() {
    return CuAsm::Test::runCheckControlCodes("Intrinsics", "sm_75") ? 0 : 1;
}
