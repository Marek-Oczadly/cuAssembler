...
/**
 * @brief Compiles the Int64Arithmetic kernel fixture for sm_75, decodes its real ptxas-scheduled control
 ...
 **/
int main() {
    return CuAsm::Test::runCheckControlCodes("Int64Arithmetic", "sm_75") ? 0 : 1;
}
