...
/**
 * @brief Compiles the CooperativeGroups kernel fixture for sm_75, decodes its real ptxas-scheduled control
 ...
 **/
int main() {
    return CuAsm::Test::runCheckControlCodes("CooperativeGroups", "sm_75") ? 0 : 1;
}
